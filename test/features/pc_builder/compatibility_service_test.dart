...
void main() {
  ...
  group('Valid builds', () {
    test('Full AMD build — AM5 CPU + AM5 board + DDR5 RAM', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_ryzen5_7600'),
        motherboard: mb('mb_b650_gaming'),
        gpu: gpu('gpu_rtx4060'),
        ram: ram('ram_32gb_ddr5_6000'),
        storage: storage('storage_1tb_nvme'),
        psu: psu('psu_750w_gold'),
        pcCase: pcCase('case_nzxt_h5'),
      );
    ...
    test('Full Intel build — LGA1700 CPU + Z790 board + DDR5 RAM', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_i5_14600k'),
        motherboard: mb('mb_z790_msi'),
        gpu: gpu('gpu_rtx4070_super'),
        ram: ram('ram_16gb_ddr5_5600'),
        storage: storage('storage_2tb_nvme'),
        psu: psu('psu_850w_gold'),
        pcCase: pcCase('case_corsair_4000d'),
      );
  ...
  group('CPU / Motherboard socket check', () {
    test('AM5 CPU + LGA1700 motherboard → error', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_ryzen5_7600'), // AM5
        motherboard: mb('mb_z790_msi'), // LGA1700
      );
    ...
    test('LGA1700 CPU + AM5 motherboard → error', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_i5_14600k'), // LGA1700
        motherboard: mb('mb_b650_gaming'), // AM5
      );
    ...
    test('Matching sockets → passed', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_ryzen7_7800x3d'), // AM5
        motherboard: mb('mb_x670_aorus'), // AM5
      );
  ...
  group('Motherboard / RAM type check', () {
    test('DDR5 motherboard + DDR4 RAM → error', () {
      final result = service.checkCompatibility(
        motherboard: mb('mb_b650_gaming'), // DDR5
        ram: ram('ram_16gb_ddr4_3200'), // DDR4
      );
    ...
    test('DDR5 motherboard + DDR5 RAM → passed', () {
      final result = service.checkCompatibility(
        motherboard: mb('mb_z790_msi'), // DDR5
        ram: ram('ram_32gb_ddr5_6000'), // DDR5
      );
  ...
  group('PSU wattage check', () {
    test('High-TDP build with small PSU → error or warning', () {
      ...
      final result = service.checkCompatibility(
        cpu: cpu('cpu_ryzen7_7800x3d'), // 120W
        gpu: gpu('gpu_rx7800xt'), // 263W
        ram: ram('ram_32gb_ddr5_6000'), // 5W
        storage: storage('storage_1tb_nvme'), // 8W
        psu: psu('psu_650w_gold'), // 650W
      );
    ...
    test('PSU with sufficient headroom → passed', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_ryzen5_7600'), // 65W
        gpu: gpu('gpu_rtx4060'), // 115W
        ram: ram('ram_16gb_ddr5_5600'), // 5W
        storage: storage('storage_1tb_nvme'), // 8W
        psu: psu('psu_650w_gold'), // 650W
      );
  ...
  group('Case / Motherboard form factor check', () {
    test('ATX motherboard in Mini-ITX case → error', () {
      final result = service.checkCompatibility(
        motherboard: mb('mb_b650_gaming'), // ATX
        pcCase: pcCase('case_nr200'), // Mini-ITX
      );
    ...
    test('Micro-ATX motherboard in ATX case → passed', () {
      final result = service.checkCompatibility(
        motherboard: mb('mb_b760_gigabyte'), // Micro-ATX
        pcCase: pcCase('case_nzxt_h5'), // ATX
      );
    ...
    test('ATX motherboard in ATX case → passed', () {
      final result = service.checkCompatibility(
        motherboard: mb('mb_z790_msi'), // ATX
        pcCase: pcCase('case_corsair_4000d'), // ATX
      );
  ...
  group('Multiple errors', () {
    test('Wrong socket + wrong RAM type → 3 errors', () {
      final result = service.checkCompatibility(
        cpu: cpu('cpu_ryzen5_7600'), // AM5, DDR5
        motherboard: mb('mb_z790_msi'), // LGA1700, DDR5
        ram: ram('ram_16gb_ddr4_3200'), // DDR4
      );
