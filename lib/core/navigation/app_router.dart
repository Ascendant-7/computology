...
GoRouter createGoRouter(AuthProvider authProvider) {
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final bool isGoingToLogin = state.uri.path == AppRoutes.login ||
    ...
    routes: [
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          ...
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.search, builder: (_, _) => const SearchPlaceholderScreen()),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.pcBuilder, builder: (_, _) => const PCBuilderScreen()),
          ]),
          StatefulShellBranch(routes: [
